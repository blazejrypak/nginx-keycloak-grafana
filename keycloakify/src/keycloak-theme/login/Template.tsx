...
import keycloakifyLogoPngUrl from "./assets/logo.svg";
        ...
        <div className={getClassName("kcLoginClass")}>
            <div id="kc-header" className={getClassName("kcHeaderClass")}>
                ...
                >
                    ...
                    */}
                    {/* <img src={`${import.meta.env.BASE_URL}logo.svg`} alt="Keycloakify logo" width={50} /> */}
                    {/* {msg("loginTitleHtml", realm.displayNameHtml)}!!! */}
                    {/* ...rely on the bundler to import your assets, it's more efficient */}
                    <div id="keycloakify-logo-wrapper">
                    <img src={keycloakifyLogoPngUrl} id="keycloakify-logo" alt="Keycloakify logo" width={300}/>
                    </div>
                </div>
            </div>
